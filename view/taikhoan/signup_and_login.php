...
<style>
    ...
    .section {
        background: rgb(173, 255, 199);
        background: radial-gradient(circle, rgba(173, 255, 199, 0.5804446778711485) 0%, rgba(246, 123, 165, 0.05103291316526615) 100%);
    }
    ...
    .card-back {
        ...
        background-color: radial-gradient(circle, rgba(238, 174, 202, 1) 0%, rgba(166, 63, 207, 1) 100%);
