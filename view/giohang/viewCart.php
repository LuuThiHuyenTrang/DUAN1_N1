        ...
        <div class="row row-pb-lg">
            <div class="col-md-12">
                ...
                <div class="product-cart d-flex">
                    <div class="one-forth">
                        <div class="product-img" style="background-image: url(/DUAN1_N1/view/images/item-6.jpg);">
                        </div>
                ...
                <div class="product-cart d-flex">
                    <div class="one-forth">
                        <div class="product-img" style="background-image: url(/DUAN1_N1/view/images/item-7.jpg);">
                        </div>
                        <div class="display-tc">
                            <h3>Product Name</h3>
                        </div>
                ...
                <div class="product-cart d-flex">
                    <div class="one-forth">
                        <div class="product-img" style="background-image: url(/DUAN1_N1/view/images/item-8.jpg);">
                        </div>
                        <div class="display-tc">
                            <h3>Product Name</h3>
                        </div>
                        ...
                        <div class="col-sm-4 text-center">
                            <div class="total">
                                ...
                                <div class="grand-total">
                                    ...
                                    <a href="index.php?duong_link=datHang"><button class="btn" style="background-color: blueviolet;">Thanh Toán</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
